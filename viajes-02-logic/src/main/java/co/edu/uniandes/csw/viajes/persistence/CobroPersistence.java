...
public class CobroPersistence {
     ...
     * @return Array con todos los cobros que perteneces a un usuario en especifico.
     */
    ...
    /**
     * Actualiza una entidad cobro de acuerdo a los datos de la entidad que entra por parametro.
