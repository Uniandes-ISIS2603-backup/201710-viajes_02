...
public class LugarPersistence {
    ...
    /**
     * Crea una nueva entidad lugar con los datos de la entidad que entra por parametro.
    ...
    /**
     * Actualiza un lugar de acuerdo a los datos de la entidad que entra po parametro
