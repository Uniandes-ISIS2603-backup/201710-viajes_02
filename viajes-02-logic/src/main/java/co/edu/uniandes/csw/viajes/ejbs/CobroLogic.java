...
public class CobroLogic {
     ...
     * @param entity Entidad que contiene la informacion que va a ir en la base de datos.
    ...
    /**
     * Encuentra los cobros que perteneces a un usuario con id que entra por parametro.
     * @param id Id del usuario al que se quiere buscar sus cobros.
     * @return  Los cobros del usuario con id que entra por parametro, un Array vacio si no hay.
     */
