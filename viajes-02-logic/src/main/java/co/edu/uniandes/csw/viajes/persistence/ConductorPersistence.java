...
public class ConductorPersistence {
    ...
    /**
     * Permite obtener la lista de todos los conductores que se encuentran activos en la base de datos.
     ...
     * @return ConductorEntity: Conductor que fué persistido en la base de datos.
     */
     ...
     * @param id: Identificador del conductor al que s ela va a añadir el vehículo.
