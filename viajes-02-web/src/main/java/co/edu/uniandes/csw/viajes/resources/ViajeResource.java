...
public class ViajeResource {
    ...
    /**
     * Método para obtener todos los viajes que se encuentran guardados en el sistema
     * @return Lista de los viajes que se encuentran en el sistema. En formato DetailDTO.
     */
    @GET
    ...
    /**
     * Método para actualizar un viaje con el id dado, que este previamente guardado en la base de datos
    ...
    /**
     * Permite obtener la información de lo viajes con el origen y destino dados.
     * @param origen. Ciudad de origen del viaje.
     * @param destino. Ciudad de destino del viaje.
     * @return Lista con la información de todos los viajes cuyo origen y destino coinciden con los dados por parametro.
     */
    @GET
    @Path("{origen: .+};(destino: .+)")
